...
class SanidadeCheck:
    ...
    def __new__(cls, *args, **kwargs):
        if not SanidadeCheck.__instance:
            SanidadeCheck.__instance = super().__new__(cls, *args, **kwargs)
    ...
    def quantidade_servidores(self):
...
for srv in range(sc1.quantidade_servidores()):
    sc1.checar_servidor(srv)

sc2.mudar_servidor()

print('Cronograma de checagem de sanidade dos servidores B...')
for srv in range(sc2.quantidade_servidores()):
